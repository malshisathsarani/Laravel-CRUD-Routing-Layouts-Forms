                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" id="inp-title" value="{{ old('title') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="price" id="inp-price" value="{{ old('price') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="inp-description" rows="3" value="{{ old('description') }}"></textarea>
